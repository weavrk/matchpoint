...
| `WorkerCardCompact` | `.worker-card-compact`      | Grids / chat teaser. Header + stats + retailer summary or work history + endorsements. About paragraph: `.compact-about` — 14px / 400, line-height 1.5, `var(--primary)`. Shift experience: `tag-blue-light tag-md`                                                                                                                                               |
