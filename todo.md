...
- **CYOA Chat** — loosen the rails: Gemini parses intent and suggests a route chip (employment / brands / experience)
- **CYOA Chat** — salary questions: pulls market data from job_postings, gives role-specific ranges
- **CYOA Chat** — job role mentions route to experience level
- **CYOA Chat** — help/summary requests give a rundown of all three filters
- **CYOA Chat** — DSL chip style, no double-prompt, user bubble width, message history scroll fix
- **Focus Step** — flip CYOA card hierarchy (description on top, title/icon below)
